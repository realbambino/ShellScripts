...
yt-dlp --download-sections *0:$start_time-0:$end_time -f "bestvideo[height<=2160][vcodec^=hevc]/bestvideo[height<=2160][vcodec^=avc1]+bestaudio[acodec^=mp4a]/best[height<= 2160]" --merge-output-format mp4 --audio-quality 0 -o "%(title)s.%(ext)s" "https://www.youtube.com/watch?v=$video_id"
